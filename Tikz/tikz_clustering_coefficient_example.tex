\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\draw (C3) -- (D3);
	\end{tikzpicture}
	\caption{Esempi di coefficienti di clustering: a sinistra un quadrato (coefficient di clustering = 0), al centro un quadrato con diagonale (coefficient di clustering = 5/6), a destra un grafo completo (coefficient di clustering = 1).}
